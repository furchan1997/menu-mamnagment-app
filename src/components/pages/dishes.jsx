...
function Dishes() {
  ...
  const { dishList, deleteDish, getDish } = useDish(); // קבלת רשימת המנות מהקונטקסט, פונקציית מחיקה
  ...
  }, [search, dishList]); // הפעולות יופעלו בכל שינוי של שדה החיפוש או רשימת המנות משתנות
  ...
  return (
    <div>
      ...
      {dishList?.length === 0 && <Warning msg={"אין מנות"} />}
