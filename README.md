...
- כולל את הפונקציות:
  ...
  - `getDish()` – מחזירה מערך של כל המנות ששמן כולל את הטקסט שנשלח (התאמה חלקית, לא תלויה באותיות גדולות/קטנות)
...
- מטפל במצבים שונים (יש מנותת מסוננות, אין מנות, אין תוצאות, וכו’)
